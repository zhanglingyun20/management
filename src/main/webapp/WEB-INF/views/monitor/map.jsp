...
<script type="text/javascript">
  ...
  function createMap(){
    ...
    var point = new BMap.Point(114.12456,22.549934);//定义一个中心点坐标
  ...
  //标注点数组
  var markerArr = [{title:"VR ",content:"VR",point:"114.125831|22.550977",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
  ];
  //创建marker
  function addMarker(){
