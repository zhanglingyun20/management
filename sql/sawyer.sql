...
CREATE TABLE `city` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=343 DEFAULT CHARSET=utf8 COMMENT='城市表';
...
CREATE TABLE `device` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'VR设备id',
  ...
  UNIQUE KEY `device_mac_2` (`device_mac`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='场地设备表';

-- ----------------------------
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES ('2', '8', 'test_mac0001', 'D_1471192124702', '测试场地', '2016-08-11 22:46:33');
...
CREATE TABLE `game_price` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account` varchar(50) NOT NULL COMMENT '场地账号',
  `game_code` varchar(50) DEFAULT NULL COMMENT '游戏编号',
...
-- ----------------------------
-- Records of game_price
-- ----------------------------
INSERT INTO `game_price` VALUES ('1', '1', null, null, '20', '2016-08-08', '1', '2016-08-08 17:59:47');
INSERT INTO `game_price` VALUES ('2', '2', null, null, '15', '2016-08-08', '1', '2016-08-08 18:00:10');
INSERT INTO `game_price` VALUES ('3', '1', null, null, '21', '2016-08-09', '0', '2016-08-09 18:00:34');
INSERT INTO `game_price` VALUES ('4', '2', null, null, '16', '2016-08-09', '0', '2016-08-09 18:00:56');
...
CREATE TABLE `game_run_record` (
  ...
  `game_name` varchar(50) DEFAULT NULL COMMENT '游戏名称',
  `game_process` varchar(50) DEFAULT NULL COMMENT '游戏进程',
  `report_time` date DEFAULT NULL COMMENT '上传日期',
  `run_count` int(11) DEFAULT NULL COMMENT '游戏运行次数',
...
-- ----------------------------
INSERT INTO `game_run_record` VALUES ('17', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_864651244', 'NAME_864651244', 'searchfilterhost.exe', '2016-08-15', '1', '2016-08-15 23:10:00', '2016-08-15 23:09:32');
INSERT INTO `game_run_record` VALUES ('18', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_1947153791', 'NAME_1947153791', 'backgroundtaskhost.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:23');
INSERT INTO `game_run_record` VALUES ('19', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_-2133092802', 'NAME_-2133092802', 'consent.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:26');
INSERT INTO `game_run_record` VALUES ('20', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_1947153791', 'NAME_1947153791', 'backgroundtaskhost.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:29');
INSERT INTO `game_run_record` VALUES ('21', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_-1288391248', 'NAME_-1288391248', 'dllhost.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:32');
INSERT INTO `game_run_record` VALUES ('22', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_-305250340', 'NAME_-305250340', 'xshell.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:51');
INSERT INTO `game_run_record` VALUES ('23', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_1663626235', 'NAME_1663626235', 'xshellcore.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:52');
INSERT INTO `game_run_record` VALUES ('24', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_-614970244', 'NAME_-614970244', 'microsoftedgecp.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:55');
INSERT INTO `game_run_record` VALUES ('25', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_1630697460', 'NAME_1630697460', 'browser_broker.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:55');
INSERT INTO `game_run_record` VALUES ('26', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_-2147476145', 'NAME_-2147476145', 'microsoftedge.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:55');
INSERT INTO `game_run_record` VALUES ('27', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_882952030', 'NAME_882952030', 'cmd.exe', '2016-08-15', '1', '2016-08-15 23:12:00', '2016-08-15 23:11:55');
INSERT INTO `game_run_record` VALUES ('28', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_864651244', 'NAME_864651244', 'searchfilterhost.exe', '2016-08-15', '1', '2016-08-15 23:13:00', '2016-08-15 23:12:01');
INSERT INTO `game_run_record` VALUES ('29', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_1947153791', 'NAME_1947153791', 'backgroundtaskhost.exe', '2016-08-15', '1', '2016-08-15 23:13:00', '2016-08-15 23:12:30');
INSERT INTO `game_run_record` VALUES ('31', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_-1857232628', 'NAME_-1857232628', 'searchprotocolhost.exe', '2016-08-15', '1', '2016-08-15 23:16:00', '2016-08-15 23:15:02');
INSERT INTO `game_run_record` VALUES ('32', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_864651244', 'NAME_864651244', 'searchfilterhost.exe', '2016-08-15', '1', '2016-08-15 23:20:00', '2016-08-15 23:19:16');
INSERT INTO `game_run_record` VALUES ('33', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_864651244', 'NAME_864651244', 'searchfilterhost.exe', '2016-08-15', '1', '2016-08-15 23:16:00', '2016-08-15 23:15:02');
INSERT INTO `game_run_record` VALUES ('34', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_-1475422321', 'NAME_-1475422321', 'qqexternal.exe', '2016-08-15', '1', '2016-08-15 23:16:00', '2016-08-15 23:15:18');
INSERT INTO `game_run_record` VALUES ('35', 'test@163.com', 'test_mac0001', 'NO.1', '深圳', 'GAME_864651244', 'NAME_864651244', 'searchfilterhost.exe', '2016-08-15', '1', '2016-08-15 23:22:00', '2016-08-15 23:21:46');
INSERT INTO `game_run_record` VALUES ('36', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_1947153791', 'NAME_1947153791', 'backgroundtaskhost.exe', '2016-08-15', '2', '2016-08-15 23:52:00', '2016-08-15 23:25:55');
INSERT INTO `game_run_record` VALUES ('37', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_-1475422321', 'NAME_-1475422321', 'qqexternal.exe', '2016-08-15', '8', '2016-08-15 23:55:00', '2016-08-15 23:27:44');
INSERT INTO `game_run_record` VALUES ('38', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_-1337510809', 'NAME_-1337510809', 'hxtsr.exe', '2016-08-15', '1', '2016-08-15 23:29:00', '2016-08-15 23:28:34');
INSERT INTO `game_run_record` VALUES ('39', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_864651244', 'NAME_864651244', 'searchfilterhost.exe', '2016-08-15', '12', '2016-08-15 23:57:00', '2016-08-15 23:29:16');
INSERT INTO `game_run_record` VALUES ('40', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_-1288391248', 'NAME_-1288391248', 'dllhost.exe', '2016-08-15', '4', '2016-08-15 23:57:00', '2016-08-15 23:29:32');
INSERT INTO `game_run_record` VALUES ('41', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_-2133092802', 'NAME_-2133092802', 'consent.exe', '2016-08-15', '1', '2016-08-15 23:33:00', '2016-08-15 23:32:36');
INSERT INTO `game_run_record` VALUES ('42', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_882952030', 'NAME_882952030', 'cmd.exe', '2016-08-15', '1', '2016-08-15 23:33:00', '2016-08-15 23:32:40');
INSERT INTO `game_run_record` VALUES ('43', 'test@163.com', 'test_mac0001', 'D_1471192124702', '深圳', 'GAME_454688989', 'NAME_454688989', 'actionuriserver.exe', '2016-08-15', '1', '2016-08-15 23:36:00', '2016-08-15 23:35:12');
...
CREATE TABLE `site` (
  ...
  `parent_id` int(11) DEFAULT '0' COMMENT '父级场地',
...
-- Records of site
-- ----------------------------
INSERT INTO `site` VALUES ('8', '0', '165', 'test_1北京', '广东省', '深圳市', '南山区', 'S_1471192124702', 'test_1test_1test_1test_1', 'city', '2016-08-15 00:28:45');
...
CREATE TABLE `users` (
  ...
  `state` varchar(10) DEFAULT NULL COMMENT '用户状态 ',
